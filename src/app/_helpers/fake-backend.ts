...
import { HttpAuthService } from '@app/_services/http-auth.service';
...
export class FakeBackendInterceptor implements HttpInterceptor {
   ...
   /* if (sessionStorage.getItem('username') && sessionStorage.getItem('token')) {
      ...
      return next.handle(request);
        ...
        function handelRoute() {
            switch (true) {
                case url.endsWith('users/authenticate') &&
                    method === 'POST': return authenticate();
        ...
        //    this.httpAuthService.Sendauthenticate(username,password);
